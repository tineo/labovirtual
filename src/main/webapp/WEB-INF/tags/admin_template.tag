<%-- 
    ...
    Created on : 23/01/2021, 06:38:36 PM
    Author     : GERSON
--%>

<%@tag description="put the tag description here" pageEncoding="windows-1252" isELIgnored="false"%>
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="${pageContext.request.contextPath}/admin/content" class="nav-link">
                                    <i class="nav-icon fas fa-th"></i>
                                    <p>
                                        Contenido
                                        <span class="right badge badge-danger">New</span>
